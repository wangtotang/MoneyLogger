...
public class BudgetTypeAdapter extends BaseAdapter {
    ...
    public BudgetTypeAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = View.inflate(context,R.layout.item_budget_dialog,null);
            viewHolder.textView = (TextView) convertView.findViewById(R.id.tv_budget_dialog);
            viewHolder.checkBox = (CheckBox) convertView.findViewById(R.id.cb_budget_dialog);
